...
namespace GaussianSplatting.Editor
{
    static class GaussianSplatUiBuilder
    {
        ...
        internal static void Generate(GaussianSplatRenderer renderer)
        {
            ...
            CreateStepperSetting("Pipeline Sort Frames", "Pipeline sort over N frames", "2", nameof(GaussianSplatRendererUI.DecreaseSortingSteps), nameof(GaussianSplatRendererUI.IncreaseSortingSteps), out generatedUi.sortingStepsLabelText, out generatedUi.sortingStepsText);
