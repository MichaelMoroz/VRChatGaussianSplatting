...
namespace GaussianSplatting.Editor.Utils
{
    ...
    public unsafe struct UnsafeSplatBuffer : IDisposable
    {
        [NativeDisableUnsafePtrRestriction]
        public InputSplatData* Data;
        public int Length;

        public UnsafeSplatBuffer(int length)
        {
            Length = length;
            Data = (InputSplatData*)UnsafeUtility.Malloc((long)length * UnsafeUtility.SizeOf<InputSplatData>(), 16, Allocator.Persistent);
        }

        public ref InputSplatData this[int index] => ref Data[index];
    ...
    public class GaussianFileReader
    {
        ...
        public static unsafe void ReadFile(string filePath, out UnsafeSplatBuffer splats)
        {
            if (isPLY(filePath))
            {
                byte* plyRawData = null;
                ...
                {
                    if (plyRawData != null) UnsafeUtility.Free(plyRawData, Allocator.Persistent);
                ...
                UnsafeUtility.Free(plyRawData, Allocator.Persistent);

                ReorderSHs(splatCount, (float*)splats.Data);
        ...
        static unsafe UnsafeSplatBuffer PLYDataToSplats(byte* input, int count, int stride, List<(string, PLYFileReader.ElementType)> attributes)
        {
            ...
            string[] splatAttributes =
            {
                ...
                "f_rest_0", "f_rest_1", "f_rest_2", "f_rest_3", "f_rest_4", "f_rest_5", "f_rest_6", "f_rest_7", "f_rest_8", "f_rest_9", "f_rest_10", "f_rest_11", "f_rest_12", "f_rest_13", "f_rest_14", "f_rest_15",
                "f_rest_16", "f_rest_17", "f_rest_18", "f_rest_19", "f_rest_20", "f_rest_21", "f_rest_22", "f_rest_23", "f_rest_24", "f_rest_25", "f_rest_26", "f_rest_27", "f_rest_28", "f_rest_29", "f_rest_30",
                "f_rest_31", "f_rest_32", "f_rest_33", "f_rest_34", "f_rest_35", "f_rest_36", "f_rest_37", "f_rest_38", "f_rest_39", "f_rest_40", "f_rest_41", "f_rest_42", "f_rest_43", "f_rest_44",
                "opacity",
            ...
            UnsafeSplatBuffer dst = new UnsafeSplatBuffer(count);
            ReorderPLYData(count, input, stride, (byte*)dst.Data, UnsafeUtility.SizeOf<InputSplatData>(), (int*)srcOffsets.GetUnsafeReadOnlyPtr());
            return dst;
        }
        ...
        {
            [NativeDisableUnsafePtrRestriction] public UnsafeSplatBuffer splatData;
        ...
        static void LinearizeData(UnsafeSplatBuffer splatData)
        {
